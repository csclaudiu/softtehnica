...
namespace API.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        {
            SoftTehnicaOperator user = await UserManager.FindByIdAsync(User.Identity.GetUserId<int>());
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            SoftTehnicaOperator user = await UserManager.FindAsync(new UserLoginInfo(externalLogin.LoginProvider,
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var user = new SoftTehnicaOperator() { UserName = model.Email, Email = model.Email, Name = model.OperatorName };
        ...
        public async Task<IHttpActionResult> RegisterExternal(RegisterExternalBindingModel model)
        {
            ...
            var user = new SoftTehnicaOperator() { UserName = model.Email, Email = model.Email };
